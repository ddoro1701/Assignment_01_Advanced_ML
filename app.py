...
def load_artifacts():
    ...
    try:
        ...
        latest_features["forecast_month"] = pd.to_datetime(

            latest_features["forecast_month"], errors="coerce"
...
def load_forecast_map():
    ...
    try:
        ...
        for feature in geojson.get("features", []):
            ...
            pred_next = props.get("pred_next", None)

            try:

                pred_next_safe = round(float(pred_next), 2)
            ...
            props["lsoa_name_safe"] = lsoa_name

            props["lsoa_code_safe"] = lsoa_code

            props["pred_next_safe"] = pred_next_safe



            if "fill_color" not in props:

                props["fill_color"] = [255, 230, 230, 160]
        ...
        st.error(f"Forecast map load failed: {e}")
...
with tab1:
    ...
    st.write(
        ...
        "Darker red areas indicate higher predicted counts."
    ...
    if forecast_map is not None:
        ...
        tooltip = {
            ...
            "html": (
                ...
                "<b>{lsoa_name_safe}</b><br/>"

                "LSOA: {lsoa_code_safe}<br/>"

                "Predicted count: {pred_next_safe}"
        ...
        st.write("No choropleth map file was found.")
    ...
    if history is not None:
        ...
        if not hist_area.empty:
            ...
            last_value = float(
                ...
                observed_df.loc[observed_df["Month"] == last_month, "crime_count"].iloc[0]
...
with tab3:
    ...
    artifact_df = pd.DataFrame({
        ...
        "Purpose": [
            ...
            "Choropleth map of predicted next-month crime counts"
